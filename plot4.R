...
par(mfrow=c(2,2))
with(x, {
  plot(x$Global_active_power~x$DateTime, xlab = "", ylab = "Global Active Power", type = "l")
  plot(x$Voltage~x$DateTime, xlab = "datetime", ylab = "Voltage", type = "l")
  ...
  plot(x$Global_reactive_power~x$DateTime, xlab = "datetime", ylab = "Global_reactive_power", type = "l")
})
dev.off()