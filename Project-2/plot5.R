...
#plot yearly sums
barplot(sums$sum, main = "Yearly Total Emissions from Coal Combustion-related sources", names.arg=sums$year, xlab = "Year", ylab = "Emissions (in tons)", col = rainbow(4), ylim = c(0,400))
